...
public class HeaderCellRendererTablaComparacion implements TableCellRenderer   {

    private JTableHeader header;

    public HeaderCellRendererTablaComparacion(JTableHeader header) {
        this.header = header;
    }
	...
	public Component getTableCellRendererComponent(JTable table, Object value,boolean isSelected,boolean hasFocus,int row,int column) {
        ...
        CambioBean fotoActual = ProcesadorTabla.fotoActualTabla.get(table.getName());
