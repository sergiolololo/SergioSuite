...
@Component
public class RESService extends ActivoComunService {
	...
	protected String getTipoActivo1() {
		return TipoActivoEnum.RES.getTipoActivo1();
	}

	@Override
	protected String getTipoActivo2() {
		return TipoActivoEnum.RES.getTipoActivo2();
	}

	@Override
	protected String getTipoActivo3() {
		return TipoActivoEnum.RES.getTipoActivo3();
	}
