...
@Component
public class CNTService extends ActivoComunService {
	...
	protected String getTipoActivo1() {
		return TipoActivoEnum.CNT.getTipoActivo1();
	}

	@Override
	protected String getTipoActivo2() {
		return TipoActivoEnum.CNT.getTipoActivo2();
	}

	@Override
	protected String getTipoActivo3() {
		return TipoActivoEnum.CNT.getTipoActivo3();
	}
