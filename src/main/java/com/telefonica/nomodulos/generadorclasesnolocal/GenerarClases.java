package com.telefonica.nomodulos.generadorclasesnolocal;
...
public class GenerarClases {
	...
	private static final String aplicacion = "prte";
	private static final String servicio = "SPOrderMng";
	private static final String servicioLocal = "SPOrderMngLocal";
	
	private static final String rutaRaizServicio = "C:\\Worskspace_spring\\srv-nuc-jee-SPOrderMng";
	...
	private static final String rutaPlantillaCommand = "C:\\T718467\\workspace\\VersionesProyectos\\src\\com\\telefonica\\generadorclasesnolocal\\plantillaClaseCommand.java";
	private static final String rutaPlantillaMapper = "C:\\T718467\\workspace\\VersionesProyectos\\src\\com\\telefonica\\generadorclasesnolocal\\plantillaClaseMapper.java";
	private static final String rutaPlantillaCommandTest = "C:\\T718467\\workspace\\VersionesProyectos\\src\\com\\telefonica\\generadorclasesnolocal\\plantillaClaseTest.java";
	...
	private static List<String> generarClaseMapperAbstract(String content, String operacionMayuscula, String operacionMinuscula) throws ClassNotFoundException, IOException {
		...
		for(Entry<Class<?>, List<Class<?>>> abstractClass: abstractClassMap.entrySet()) {
			...
			for(Class<?> classChild: abstractClass.getValue()) {
				if(abstractClassMap.get(classChild) == null){
					lines2.addAll(generarMapeoAbstracto(operacionMinuscula, classChild.getSimpleName()));
				}
